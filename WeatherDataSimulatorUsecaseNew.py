...
class WeatherDataSimulatorUsecaseNew(object):
    
    #Initialise the class variables
    def __init__(self):
        self.city_list = ['Sydney', 'Melbourne','Brisbane','Adelaide','Perth','Canberra',
                          'Darwin','Hobart','GoldCoast','Newcastle','Cairns','Toronto',
                          'Los Angeles','Chicago','London','Bangkok','Dallas',
                          'Johannesburg','Chennai','Boston','Miami', 'Santiago'
                          'Bangalore','Hyderabad','Madrid',
...
if __name__ == "__main__":
    c = WeatherDataSimulatorUsecaseNew()
    c.generateWeather()